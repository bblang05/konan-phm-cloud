...
export function ChangePasswordDay(): React.JSX.Element {
                        ...
                        <DialogContent>
                            <Box pb="20px">
                                <DialogContentText id="alert-dialog-slide-description">
                                    <Typography>마지막 비밀번호 갱신일로부터 <Typography color='var(--mui-palette-primary-main)'
                                                                            display="inline-block">90일</Typography>이
                                        지났습니다.</Typography>
                                    소중한 개인정보보호를 위해 새로운 비밀번호로 변경해 주시기 바랍니다.
                                </DialogContentText>
                            </Box>
                            <PasswordChangeTable/>
                        </DialogContent>
